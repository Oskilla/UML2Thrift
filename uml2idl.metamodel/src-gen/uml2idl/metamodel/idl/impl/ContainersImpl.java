 ...
 * </p>
 * <ul>
 *   <li>{@link uml2idl.metamodel.idl.impl.ContainersImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContainersImpl extends MinimalEObjectImpl.Container implements Containers {
	...
	protected EClass eStaticClass() {
		return IdlPackage.Literals.CONTAINERS;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.CONTAINERS__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IdlPackage.CONTAINERS__NAME:
			return getName();
		}
