...
import uml2idl.metamodel.idl.map;
 ...
 * </p>
 * <ul>
 *   <li>{@link uml2idl.metamodel.idl.impl.mapImpl#getContainers <em>Containers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class mapImpl extends MinimalEObjectImpl.Container implements map {
	...
	protected EClass eStaticClass() {
		return IdlPackage.Literals.MAP;
	}
	...
	public EList<Containers> getContainers() {
		if (containers == null) {
			containers = new EObjectResolvingEList<Containers>(Containers.class, this, IdlPackage.MAP__CONTAINERS);
		}
		return containers;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IdlPackage.MAP__CONTAINERS:
