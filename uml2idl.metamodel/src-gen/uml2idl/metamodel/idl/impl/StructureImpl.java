 ...
 * </p>
 * <ul>
 *   <li>{@link uml2idl.metamodel.idl.impl.StructureImpl#getField <em>Field</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructureImpl extends TypeImpl implements Structure {
	...
	public EList<Field> getField() {
		if (field == null) {
			field = new EObjectContainmentEList<Field>(Field.class, this, IdlPackage.STRUCTURE__FIELD);
		}
		return field;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case IdlPackage.STRUCTURE__FIELD:
