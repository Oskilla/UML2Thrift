...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Field Byte Array</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class FieldByteArrayImpl extends MinimalEObjectImpl.Container implements FieldByteArray {
	 ...
	 * @ordered
	 */
	protected static final ByteArray VALUES_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected ByteArray values = VALUES_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return IdlPackage.Literals.FIELD_BYTE_ARRAY;
	}
	 ...
	 * @generated
	 */
	public void setValues(ByteArray newValues) {
		ByteArray oldValues = values;
		values = newValues;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.FIELD_BYTE_ARRAY__VALUES, oldValues,
					values));
	}
