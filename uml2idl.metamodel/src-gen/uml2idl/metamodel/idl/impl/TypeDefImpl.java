 ...
 * </p>
 * <ul>
 *   <li>{@link uml2idl.metamodel.idl.impl.TypeDefImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeDefImpl extends MinimalEObjectImpl.Container implements TypeDef {
	...
	protected EClass eStaticClass() {
		return IdlPackage.Literals.TYPE_DEF;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.TYPE_DEF__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IdlPackage.TYPE_DEF__NAME:
			return getName();
		}
